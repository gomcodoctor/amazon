...
class MarketplaceWebServiceProducts_Client implements MarketplaceWebServiceProducts_Interface
{
     ...
     */
    protected function _convertGetLowestPricedOffersForASIN($request) {
     ...
     */
    protected function _convertGetLowestPricedOffersForSKU($request) {
     ...
     */
    protected function _convertGetMyFeesEstimate($request) {
