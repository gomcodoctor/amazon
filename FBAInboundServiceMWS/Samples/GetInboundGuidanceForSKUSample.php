...
/**
 * Get Inbound Guidance For SKU Sample
 */
 ...
 * sample for Get Inbound Guidance For SKU Action
 ***********************************************************************/
 // @TODO: set request. Action can be passed as FBAInboundServiceMWS_Model_GetInboundGuidanceForSKU
 $request = new FBAInboundServiceMWS_Model_GetInboundGuidanceForSKURequest();
 $request->setSellerId(MERCHANT_ID);
 // object or array of parameters
 invokeGetInboundGuidanceForSKU($service, $request);

/**
  * Get Get Inbound Guidance For SKU Action Sample
  * Gets competitive pricing and related information for a product identified by
  * the MarketplaceId and ASIN.
  *
  * @param FBAInboundServiceMWS_Interface $service instance of FBAInboundServiceMWS_Interface
  * @param mixed $request FBAInboundServiceMWS_Model_GetInboundGuidanceForSKU or array of parameters
  */

  function invokeGetInboundGuidanceForSKU(FBAInboundServiceMWS_Interface $service, $request)
  {
      try {
        $response = $service->GetInboundGuidanceForSKU($request);
