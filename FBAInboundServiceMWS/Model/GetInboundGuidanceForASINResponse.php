 ...
 */
 ...
 class FBAInboundServiceMWS_Model_GetInboundGuidanceForASINResponse extends FBAInboundServiceMWS_Model {

    public function __construct($data = null)
    {
    $this->_fields = array (
    'GetInboundGuidanceForASINResult' => array('FieldValue' => null, 'FieldType' => 'FBAInboundServiceMWS_Model_GetInboundGuidanceForASINResult'),
    ...
    public static function fromXML($xml)
    {
        ...
        if ($response->length == 1) {
            return new FBAInboundServiceMWS_Model_GetInboundGuidanceForASINResponse(($response->item(0))); 
        } else {
